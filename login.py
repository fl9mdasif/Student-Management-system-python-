...
class Login_window:
    def __init__(self, root):
        ...
        btn_reg=Button(login_frame,text="Register New Account?",font=("times new roman",14),bg="white",bd=0,fg="#B00857",cursor="hand2",command=self.register_window).place(x=250,y=330)
        btn_forget=Button(login_frame,text="Forget Password?",font=("times new roman",14),bg="white",bd=0,fg="red",cursor="hand2",command=self.forget_password_window).place(x=450,y=330)
        ...
        if self.txt_email.get()=="":
            ...
            try:
                ...
                if row==None:
                    ...
                    btn_change_password=Button(self.root2,text="Reset Password",font=("times new roman",15,"bold"),bg="green",bd=0,fg="white",command=self.forget_password).place(x=90,y=340)
