...
class Register:
    def __init__(self, root):
        ...
        #====bg image====#
        self.bg=ImageTk.PhotoImage(file="images/reg.jpg")
        ...
        title=Label(frame1,text="REGISTER HERE ✍", font=("times new roman",20,"bold"),bg="white",fg="orange").place(x=50,y=30)
        ...
        self.btn_img=ImageTk.PhotoImage(file="images/regbuttt.png")
        btn=Button(frame1,image=self.btn_img,bd=0,cursor="hand2",command=self.register_data).place(x=50,y=420)
